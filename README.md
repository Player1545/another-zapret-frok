...
<b>Рекомендую использовать файлы general(ALT11) или general(ALT18), на остольных файлах general(ALT...) могут не работать некоторые сайты(или звонки в телеграме/дискорде)</b>
